package com.project.schoolmanagment.contactmessage.messages;
...
public class Messages {
	...
	public static final String CONTACT_MESSAGE_DELETED_SUCCESFULLY = "Contact message deleted Successfully";
}
